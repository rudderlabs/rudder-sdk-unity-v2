...
{
    public class UnityRequestHandler : IUnityRequestHandler
    {
        ...
        internal UnityRequestHandler(TimeSpan timeout) : this(timeout, new Backo(max: 10000, jitter: 5000)) // Set maximum waiting limit to 10s and jitter to 5s
        {
        }

        internal UnityRequestHandler(TimeSpan timeout, Backo backo)
        {
            _backo  = backo;
            Timeout = timeout;
        }
